...
def compare_runs(db: Session = Depends(get_db)):
    ...
    return {
        ...
        "anomalies": anomalies,
        "metrics": {"latest_duration": latest.duration_ms, "avg_duration": round(avg_dur, 2)}
    }
"""

# 3. app/main.py (Safe Mode - No JSON Logging to prevent crashes)
...
@app.get("/")
def read_root():
    return {"message": "Crypto System Online - Fixed"}
"""
...
if __name__ == "__main__":
    ...
    print("🚀 Project files repaired. Please restart Docker.")